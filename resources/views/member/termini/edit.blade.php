...
<h4 style="font-weight:800;color:#1C1C1E;margin-bottom:1.5rem;">
    <a href="{{ route('member.termini') }}" style="color:#8E8E93;text-decoration:none;">Termini</a>
...
<div class="glass-card p-4" style="max-width:700px;">
    ...
    <form method="POST" action="{{ route('member.termini.update', $termin) }}">
        @csrf @method('PUT')
        <div class="mb-3">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('member.termini') }}" class="btn" style="background:#f0f0f0;color:#555;font-weight:600;border-radius:10px;padding:10px 24px;">Odustani</a>
        </div>
    </form>
</div>
